package com.bluewolftek.www.myprototype;
...
public class ToolTestUtils {
    ...
    public Tool getNewTool(ToolType toolType, ToolPagerAdapter.Tab tab) {
        ...
        String description = "The latest and greatest from " + brand + " takes " +
                toolType.name().toLowerCase(Locale.getDefault()) + " to a whole new level. " +
                "Tenderloin corned beef tail, tongue landjaeger boudin kevin ham pig pork loin " +
                "short loin shoulder prosciutto ground round. Alcatra salami sausage short " +
                "ribs t-bone, tongue spare ribs kevin meatball tenderloin. Prosciutto tail " +
                "meatloaf, chuck pancetta kielbasa leberkas tenderloin drumstick meatball " +
                "alcatra cow sausage corned beef pork belly. Shoulder swine hamburger " +
                "tail ham hock bacon pork belly leberkas beef ribs jowl spare ribs.";
